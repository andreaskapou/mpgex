...
#'
#' \code{mpgex_regress} is a function that wraps all the necessary subroutines
...
#' out   <- mpgex_regress(x = obs, y = y, basis = basis)
#'
#' @export
mpgex_regress <- function(formula = NULL, x, y, model_name = "lm",
